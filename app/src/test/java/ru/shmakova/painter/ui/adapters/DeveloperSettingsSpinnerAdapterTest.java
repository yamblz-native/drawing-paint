package ru.shmakova.painter.ui.adapters;
...
import ru.shmakova.painter.ui.adapters.DeveloperSettingsSpinnerAdapter.SelectionOption;
...
public class DeveloperSettingsSpinnerAdapterTest {
    ...
    public void getDropDownView_shouldBindDataAndReturnViewWithoutConvertView() {
        ...
        for (int position = 0; position < selectionOptions.size(); position++) {
            ...
            View view = mock(View.class);
            when(layoutInflater.inflate(ru.shmakova.painter.R.layout.list_developer_settings_spinner_drop_down_item, container, false)).thenReturn(view);
